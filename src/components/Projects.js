...
export const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Shopping app using Shopfy api with React",
      imgUrl:shopify,
    ...
    {
      title: "Twitter 2.0",
      description: "Recreation of a Twitter app using Sanity.Io CMS and React and Typscript",
      imgUrl:twitter,
      Link:'https://twiter-clone2-0.vercel.app/',
      Github:"https://github.com/nejc000l/twiter_clone2.0",

    },
    {
      title: "AirBnb",
      description: "An AirBnb type landing page with map and geocordinate location build in React",
      imgUrl:aire,
      Link:'https://twiter-clone2-0.vercel.app/',
    ...
    {
      title: "Reddit 2.0",
      description: "A reddit type application that build in Typescript Sanity.Io and React",
      imgUrl:reddit,
      Link:'https://reddit2-0-two.vercel.app/',
      Github:"https://github.com/nejc000l/Reddit2.0",
    },
    {
